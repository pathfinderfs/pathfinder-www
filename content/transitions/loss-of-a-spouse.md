...
sections:
  ...
  - kind: "checklist"
    ...
    intro: "The exact list depends on the estate plan and the accounts, but early work often includes:"
    items:
      - "Locate the will, trusts, beneficiary information, account statements, insurance policies, and recent tax returns."
      - "Confirm near-term cash, household bills, insurance coverage, and any benefit or claim deadlines."
      - "Notify the appropriate institutions without closing access to records that are still needed."
      - "Identify required distributions, tax filings, probate questions, and work that belongs with an attorney or CPA."
      - "Make a separate list of investment, housing, gifting, and lifestyle choices that can wait."
  - kind: "cards"
    tone: "tint"
    ...
    items:
      ...
      - title: "Accounts and investments"
        body: "We identify what is owned, how it is titled, what each account is for, and whether the current investments still fit the survivor's needs and tolerance for risk."
      - title: "Help and decision-making"
        body: "The spouse who died may also have been the household record keeper and sounding board. We discuss who can help now and whether powers of attorney, trustees, and estate documents still make sense."
  - kind: "prose"

...
weight: 30
description: "What it is like to work with Pathfinder: a free first conversation, clear next steps, direct advice, and a process paced to the decision in front of you."
...
process:
  ...
  intro: "Some situations need fast sorting and slower planning after that. Others can move steadily from the start. The process should fit the facts and your comfort, not a canned schedule."
  items:
    - title: "Discover"
      body: "Understand your goals, constraints, timing, family needs, tax facts, investments, and what would make a bad outcome hard to recover from."
    - title: "Decide"
...
standards:
  ...
  links:
    - label: "Fee-only"
      ...
      body: "Pathfinder is paid directly by clients, not by commissions or product sales."
      href: "/about/fee-only/"
    - label: "Fiduciary"
      title: "Your interest comes first"
      body: "Pathfinder is legally required to put the client's interests first."
